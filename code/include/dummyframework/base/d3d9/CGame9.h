...
namespace DummyFramework
{
	...
	public:
		...
		inline void DrawImage(const D3DXMATRIX& transform, unsigned int color = 0xffffffff) {
			screenquad->Draw(transform, color);
		}

		inline void DrawImage(const D3DXMATRIX& transform, float texcoords[4], unsigned int color) {
