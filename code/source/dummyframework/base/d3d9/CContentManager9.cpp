...
// ez a két paraméter kell a Quantum-bol
...
namespace DummyFramework
{
    ...
    LPD3DXMESH CContentManager9::CreateBox(float width, float height, float depth)
    {
        ...
        unsigned long id = GenerateUniqueMeshID();
    ...
    {
        LPDIRECT3DTEXTURE9 tex = NULL;
        unsigned long id = GenerateUniqueTextureID();
    ...
    //=============================================================================================================
    bool CContentManager9::FillTexture(LPDIRECT3DTEXTURE9 texture, unsigned long color)
    {
        if( !texture )
            return false;
    ...
    //=============================================================================================================
    unsigned long CContentManager9::GenerateUniqueMeshID()
    {
        unsigned long size = (unsigned long)createdmeshes.size() + 1;
    ...
    //=============================================================================================================
    unsigned long CContentManager9::GenerateUniqueTextureID()
    {
        unsigned long size = (unsigned long)createdtextures.size() + 1;

        for( unsigned long i = 1; i < size; ++i )
        {
            // nem lenne jo, ha a device lostkor kimentett id-kböl választana
