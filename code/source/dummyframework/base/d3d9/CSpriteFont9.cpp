...
namespace DummyFramework
{
    ...
    //=============================================================================================================
    void CSpriteFont9::SetTextColor(size_t groupid, size_t textid, unsigned long color)
    {
    ...
    //=============================================================================================================
    void CSpriteFont9::SetTextAlignment(size_t groupid, size_t textid, unsigned long alignment)
    {
    ...
    void CSpriteFont9::Set(size_t groupid, size_t textid, const std::string& text, const D3DXVECTOR2& position,
        unsigned long alignment, unsigned long color)
    {
