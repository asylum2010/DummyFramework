...
void Script::stm_Message(char* params)
{
    ...
    game->execdelay = (long)((length == 0 ? (game->avatarbubble.IdleDelay + 10) : length));
}
//=============================================================================================================
void Script::stm_Enemy(char* params)
{
    long type, height, width, track, speed;
...
void Script::stm_Tutorial(char* params)
{
    ...
    game->execdelay = (long)GameVariables::ReadLength(*str) + 14;
}
//=============================================================================================================
void Script::stm_Title(char* params)
{
    ...
    game->hud.Title(*str);
    game->execdelay = (long)GameVariables::ReadLength(*str) + 25;
}
//=============================================================================================================
